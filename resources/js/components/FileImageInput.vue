...
<template>
  <div class="space-y-2">
    ...
    <div
      class="aspect-video cursor-pointer overflow-hidden rounded-xl border bg-slate-50 relative group"
    >
      <img
        v-if="previewUrl"
        :src="previewUrl"
      ...
      />
      <ImagePlus v-else class="size-full p-4 text-slate-500" :absoluteStrokeWidth="true"  @click="inputRef?.click()"/>
